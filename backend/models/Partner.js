...
import PendingPartner from '../models/PendingPartner.js'; // PRIDĖTI ŠĮ IMPORTĄ
import Partner from '../models/Partner.js'; // PRIDĖTI ŠĮ IMPORTĄ
...
router.post('/partners/register', async (req, res) => {
    try {
        ...
        // Išsaugojimas MongoDB - NAUDOTI IMPORTUOTĄ MODELĮ
